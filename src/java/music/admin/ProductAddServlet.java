...
@WebServlet(name = "ProductMaintenanceServelet", urlPatterns = {"/ProductMaintenanceServelet"})
public class ProductAddServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println(
                ...
                + " </tr>\n"
                + " </table>\n"
                + "<p>To enter another product, click the back button in your browser.</p>\n"
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ProductMaintenanceServelet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ProductMaintenanceServelet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
